...
#ifndef KERNEL_ELF_PADDR_BASE_START
#define KERNEL_ELF_PADDR_BASE_START 0x4000000
#endif /* KERNEL_ELF_PADDR_BASE_START */
#define KERNEL_ELF_PADDR_BASE (physBase + UL_CONST(KERNEL_ELF_PADDR_BASE_START))
